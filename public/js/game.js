...
function createEnemy() {
  ...
  setTimeout(function() {
    enemy.visibilityHandlerID = setInterval(enemyVisibilityHandler, 5000, enemy);
  }, Math.random() * 3000);
...
function enemyFiringHandler(enemy) {
  ...
  if (Math.random() > 0.25 && !enemy.classList.contains("hide") && !enemy.classList.contains("appear")) {
